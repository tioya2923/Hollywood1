window.onload = function() {
    ...
    const aPeople = document.getElementById("aPeople")

    aPeople.addEventListener("click", function() {
        document.getElementById("sponsors").scrollIntoView({ behavior: 'smooth' })
    })

    aPeople.addEventListener("mouseover", function() {
        document.getElementById("aPeople").style.cursor = "pointer";
    })
    ...
    btnRegister.addEventListener("click", function() {
        swal({
            ...
            preConfirm: () => {
                ...
                return fetch(`${urlBase}/hollywood/1/users/${email}`, {
                        headers: {
                            "Content-Type": "application/x-www-form-urlencoded"
                        },
                        method: "POST",
